...
class App:
    def __init__(self, root):
        ...
        Conversion_amount.place(x=250,y=50,width=70,height=25)
        ...
        Currency_requested.place(x=250,y=100,width=70,height=25)

        Staff_label=tk.Label(root)
        ft = tkFont.Font(family='Times',size=10)
        Staff_label["font"] = ft
        Staff_label["fg"] = "#333333"
        Staff_label["anchor"] = "w"
        Staff_label["text"] = "Is the customer a member of staff?"
        Staff_label.place(x=20,y=150,width=240,height=30)
        ...
        Staff_chk["text"] = "Yes"
        Staff_chk.place(x=260,y=150,width=70,height=25)
        ...
        Calculate_btn.place(x=130,y=190,width=80,height=25)
    ...
    def Calculate_btn_command(self, amount, type, staff, converse, trans, dis, tot, error):
        ...
        if is_float(amount) and float(amount) >= 0 and float(amount) <= 2500:
            error["text"] = ""
            amount = float(amount)
